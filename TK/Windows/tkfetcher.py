...
def scrape_user_data(username):
  ...
  try:
    ...
    avatar_img = driver.find_element(By.CSS_SELECTOR, "img[src*='tiktokcdn.com']").get_attribute("src")
    user_handle = driver.find_element(By.CSS_SELECTOR, "h1[data-e2e = 'user-title']").text
    display_name = driver.find_element(By.CSS_SELECTOR, "h2[data-e2e = 'user-subtitle']").text
