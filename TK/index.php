...
<body>
    <div class="container">
        ...
        if(isset($_GET['argument'])){
            ...
            $command = "python tkfetcher.py " . $escapedArgument;
            ...
            if(count($lines) < 3) {
                ...
                foreach ($lines as $index => $line) {
                    if (strpos($line, "Likes Count:") === 0) {
                        $likes = trim(str_replace("Likes Count:", "", $lines[$index]));
                        break;
                    }
                }
                foreach ($lines as $index => $line) {
                ...
                echo '<p class="pcount">' . $likes . ' <strong>Likes</strong></p>';
                echo '</div>';
                echo '</div>';
            }
        }
